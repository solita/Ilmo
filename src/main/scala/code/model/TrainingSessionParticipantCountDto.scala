...
class TrainingSessionParticipantCountDto(id: Long, name: String, date: Date, place: String, hasSignedInUserParticipated: Boolean, participantCount: Long, maxParticipants: Long) {
  def id() : Long = id;
